    ...
    <div class="max-w-7xl mx-auto px-4 py-6 flex justify-between items-center">
      ...
      <nav>
        <ul class="flex space-x-4">
          ...
          <li><a href="pet/list.php" class="text-gray-600 hover:text-blue-500">ペット一覧</a></li>
    ...
    <div class="max-w-7xl mx-auto px-4">
      ...
      <section class="my-12" id="petCategories">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <a href="pet/list.php?animal_id=1" class="bg-white p-6 rounded-lg shadow pet-card">
          ...
          <a href="pet/list.php?animal_id=2" class="bg-white p-6 rounded-lg shadow pet-card">
          ...
          <a href="pet/list.php?animal_id=3" class="bg-white p-6 rounded-lg shadow pet-card">
