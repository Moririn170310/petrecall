<?php
// ここでは $_POST にデータを渡していると仮定しています
$dogName = $_POST['dog_name'];
$userName = $_POST['user_name'];
$email = $_POST['email'];
$address = $_POST['address'];
$phone = $_POST['phone'];
$imagePath = 'uploads/' . $_FILES['dog_image']['name'];
?>
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-lg shadow-md w-96">
        ...
        <div class="mb-4">
            ...
            <p class="mt-1 text-gray-600"><?php echo $dogName; ?></p>
        </div>
        <div class="mb-4">
            <strong class="block text-gray-700">ユーザ名:</strong>
            <p class="mt-1 text-gray-600"><?php echo $userName; ?></p>
        </div>
        <div class="mb-4">
            <strong class="block text-gray-700">Email:</strong>
            <p class="mt-1 text-gray-600"><?php echo $email; ?></p>
        </div>
        <div class="mb-4">
            <strong class="block text-gray-700">犬の画像:</strong>
            <img src="<?php echo $imagePath; ?>" alt="犬の画像" class="mt-2 w-full h-auto rounded-md">
        </div>
        <div class="mb-4">
            <strong class="block text-gray-700">住所:</strong>
            <p class="mt-1 text-gray-600"><?php echo $address; ?></p>
        </div>
        <div class="mb-4">
            <strong class="block text-gray-700">電話番号:</strong>
            <p class="mt-1 text-gray-600"><?php echo $phone; ?></p>
        </div>
